...
Product design tickets: `.scratch/coding-orchestrator/` (spec + 01–08). Operator surface: `.scratch/operator-surface/`. Glossary `CONTEXT.md`. Decisions `docs/adr/` (through ADR-0031). This Feature is module alignment only.
